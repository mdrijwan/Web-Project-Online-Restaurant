...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginFailed = "loginfails.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_delicious_conn, $delicious_conn);
  
  $LoginRS__query=sprintf("SELECT username, password FROM user_login WHERE username=%s AND password=%s",
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "email", {minChars:1, validateOn:["blur", "change"]});
</script>
</body>
</html>