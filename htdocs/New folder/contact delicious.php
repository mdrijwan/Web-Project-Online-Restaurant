...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>
    <label for="feedbackpw">Contact number:<br />
    </label>
    <input type="text" name="feedbackpw" id="feedbackpw" />
  </p>
  <p>
    <label for="feedbackemail">Email:<br />
    </label>
    <input type="text" name="feedbackemail" id="feedbackemail" />
  </p>
  <p>
    <label for="feedbackarea">Your Feedback:</label>
  </p>
  <p>
    <textarea name="feedbackarea" id="feedbackarea" cols="45" rows="5"></textarea>
  </p>
  <p>
